...
export const rifle: Template = {
  ...
  slots: [
    ...
    { id: 'magazine', family: 'magazine', params: { capacity: SML } },
...
export const smg: Template = {
  ...
  slots: [
    ...
    { id: 'magazine', family: 'magazine', params: { capacity: ['M', 'L'] } },
...
export const boltRifle: Template = {
  ...
  slots: [
    ...
    { id: 'magazine', family: 'magazine', params: { capacity: 'S' } },
...
export const boltRifleBox: Template = {
  ...
  slots: [
    ...
    { id: 'magazine', family: 'magazine', params: { capacity: ['S', 'M'] } },
    { id: 'stock', family: 'stock', params: { length: ['M', 'L'], style: 'sporting' } },
    { id: 'sight', family: 'sight', chance: 0.9 },
  ],
  connections: [
