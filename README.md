...
| Dir | Status | Summary |
| --- | --- | --- |
| [`gungen/`](gungen/PROJECT.md) | milestone 1 done: validator and viewer | A super-low-poly 3D firearm generator that works out how components connect, so every generated assembly fits together. |
